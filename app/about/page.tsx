  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative group pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div
          className="absolute inset-0 bg-[url('/banners/about/banner.jpg')] bg-cover bg-center filter grayscale group-hover:grayscale-0 transition-all duration-700 ease-in-out -z-10"
        />
