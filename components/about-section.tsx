        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed text-pretty">
              For over three decades, KA Four Oil & Gas Services LLC has been at the forefront of energy innovation, combining cutting-edge
          ...
          <div className="relative animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            <img
              ...
              alt="KA Four Oil and Gas facility"
